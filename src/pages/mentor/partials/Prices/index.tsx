  ...
  return (
    <Card className={clsx(s.root, className)}>
      ...
      <div className={s.root__row}>
        ...
        <div><span className={s.root__price}>{priceWithLocale(price)}</span>/ час</div>
      </div>

      {user.discountForFiveSessions &&
      <div className={s.root__row}>
        <Discount condition={user.discountForFiveSessions} percent={5}/>
        <div><span className={s.root__price}>{priceWithLocale(countDiscount(5, price))}</span>/ час</div>
      </div>
      }
      ...
      <div className={s.root__row}>
        ...
        <div><span className={s.root__price}>{priceWithLocale(countDiscount(10, price))}</span>/ час</div>
      </div>}
